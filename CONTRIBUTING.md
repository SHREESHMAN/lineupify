...
2. `git push --follow-tags`. The Release workflow runs the checks, publishes to npm with provenance, builds the Claude Desktop `.mcpb` and attaches it to the GitHub release.
